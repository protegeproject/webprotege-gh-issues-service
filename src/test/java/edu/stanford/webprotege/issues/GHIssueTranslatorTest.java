...
import edu.stanford.webprotege.issues.translator.*;
...
class GHIssueTranslatorTest {
    ...
    @Mock
    private GHUser ghAssignee;

    @Mock
    private GHUser ghUser;

    @Mock
    private GHUser ghClosedBy;

    @Mock
    private PagedIterable<GHReaction> ghReactionsIterator;
