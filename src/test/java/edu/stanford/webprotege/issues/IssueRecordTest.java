...
public class IssueRecordTest {
    ...
    public void shouldCreateObjectWithConstructor() {
        ...
        Assertions.assertThat(issueRecord.oboIds()).isEqualTo(oboIds);
        Assertions.assertThat(issueRecord.iris()).isEqualTo(iris);
    }
    ...
    public void shouldDeserializeJson() throws IOException {
        ...
        Assertions.assertThat(issueRecord.iris()).containsExactly(Iri.valueOf("https://example.org/A"));
        Assertions.assertThat(issueRecord.oboIds()).containsExactly(OboId.valueOf("GO:1234567"));
    }
